...
exports.TeamEnvsTeamResolver = void 0;
...
let TeamEnvsTeamResolver = class TeamEnvsTeamResolver {
    constructor(teamEnvironmentService) {
        this.teamEnvironmentService = teamEnvironmentService;
    }
    teamEnvironments(team) {
        return this.teamEnvironmentService.fetchAllTeamEnvironments(team.id)();
    }
};
__decorate([
    (0, graphql_1.ResolveField)(() => [team_environments_model_1.TeamEnvironment], {
...
], TeamEnvsTeamResolver.prototype, "teamEnvironments", null);
TeamEnvsTeamResolver = __decorate([
...
exports.TeamEnvsTeamResolver = TeamEnvsTeamResolver;
