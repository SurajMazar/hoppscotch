import { UserRequest, UserRequestReorderData } from 'src/user-request/user-request.model';
...
import { UserHistory, UserHistoryDeletedManyData } from '../user-history/user-history.model';
import { TeamMember } from 'src/team/team.model';
import { TeamEnvironment } from 'src/team-environments/team-environments.model';
import { CollectionReorderData, TeamCollection } from 'src/team-collection/team-collection.model';
import { RequestReorderData, TeamRequest } from 'src/team-request/team-request.model';
import { TeamInvitation } from 'src/team-invitation/team-invitation.model';
import { InvitedUser } from '../admin/invited-user.model';
import { UserCollection } from '@prisma/client';
import { UserCollectionRemovedData, UserCollectionReorderData } from 'src/user-collection/user-collections.model';
...
export type TopicDef = {
    ...
    [topic: `user_environment/${string}/${'created' | 'updated' | 'deleted'}`]: UserEnvironment;
    [topic: `user_environment/${string}/deleted_many`]: number;
    [topic: `user_request/${string}/${'created' | 'updated' | 'deleted'}`]: UserRequest;
    [topic: `user_request/${string}/${'moved'}`]: UserRequestReorderData;
    [topic: `user_history/${string}/${'created' | 'updated' | 'deleted'}`]: UserHistory;
    [topic: `user_coll/${string}/${'created' | 'updated' | 'moved'}`]: UserCollection;
    ...
    [topic: `team_environment/${string}/${'created' | 'updated' | 'deleted'}`]: TeamEnvironment;
    [topic: `team_coll/${string}/${'coll_added' | 'coll_updated'}`]: TeamCollection;
    ...
    [topic: `team_req/${string}/${'req_created' | 'req_updated' | 'req_moved'}`]: TeamRequest;
